...
const Login = () => {
  ...
  const isLoggedIn = useSelector((state) => state.auth.isLoggedIn); // this state determines if the user is logged in
  ...
  const handleSubmit = (e) => {
    ...
    if (!email || !password) return toast.dark("Please fill in all fields!"); // Checks if all the required fields heve been filled
